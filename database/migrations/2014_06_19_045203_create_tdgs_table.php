...
class CreateTdgsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tdgs', function (Blueprint $table) {
            ...
            $table->enum('estado_oficial',['Aprobado','Oficializado','Abandonado','Prórroga','Extensión de prórroga','Prórroga especial','Finalizado'])->nullable();
            $table->enum('solicitud_escuela',['Recien ingresado','Asignación','Abandonado','Prórroga','Extensión de prórroga','Prórroga especial','Tribunal','Resultados','Finalizado'])->nullable();
