<div class="row">
    <div class="col-md-3">
        <div class="input-group mb-3">
            ...
            <select id="select-filter-estado" class="form-control" class="custom-select">
                <option value="" selected disabled>Seleccione el estado:</option>
                <option value="Recien ingresado">Recien ingresado</option>
    ...
    <div class="col-md-4">
        <div class="input-group mb-3">
            ...
            <input type="text" id="txt-filtro-estudiante" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Nombre o apellido">
        </div>
    </div>
    <div class="col-md-1">
